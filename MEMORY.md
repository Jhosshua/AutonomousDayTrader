...
Plan: `PLAN_2026_09_24_operator_windows.md` (Codex attacked it: 27 findings, triage recorded in the file).
...
- Deferred (must do): half-day early close (flattening still 15:55; next half day 2026-11-27); entries placed just before a window closes are not cancelled at the boundary; strategy-internal "no setup" funnel; close finalization if the bot restarts after 16:00.
